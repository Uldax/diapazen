...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'diapazen', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_982a9d9b5fa3ebf171864fe0f1d4b8e23029ce7ad8e36658b7b6d1b151edd608');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_982a9d9b5fa3ebf171864fe0f1d4b8e23029ce7ad8e36658b7b6d1b151edd608');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_982a9d9b5fa3ebf171864fe0f1d4b8e23029ce7ad8e36658b7b6d1b151edd608');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine' => 'FOS\\UserBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\src\\Bdls\\ProjetBundle\\Entity')), 'Bdls\\ProjetBundle\\Entity');
        $e->addDriver($d, 'FOS\\UserBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('BdlsProjetBundle' => 'Bdls\\ProjetBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Bdls\\ProjetBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Bdls\\ProjetBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Bdls\\ProjetBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.facebook'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\FacebookResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '359610224180052', 'client_secret' => '56f4d32675c0fd39a2986e5a1ac514e9', 'scope' => 'email', 'infos_url' => 'https://graph.facebook.com/me?fields=username,name,email,picture.type(large)', 'paths' => array('email' => 'email', 'profilepicture' => 'picture.data.url'), 'options' => array('display' => 'popup')), 'facebook', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.github'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\GitHubResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '<client_id>', 'client_secret' => '<client_secret>', 'scope' => 'user:email', 'paths' => array(), 'options' => array()), 'github', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.google'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\GoogleResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '330767389348-acuj6f53cs45k4ge789jce27go8naoi9.apps.googleusercontent.com', 'client_secret' => 'rIV9URsXROGewOrSbuynMYOS', 'scope' => 'https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile', 'paths' => array('email' => 'email', 'profilepicture' => 'picture'), 'options' => array()), 'google', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        $this->services['hwi_oauth.resource_ownermap.secure_area'] = $instance = new \HWI\Bundle\OAuthBundle\Security\Http\ResourceOwnerMap($this->get('security.http_utils'), array(0 => 'github', 1 => 'facebook', 2 => 'google'), array('github' => '/login/check-github', 'facebook' => '/login/check-facebook', 'google' => '/login/check-google'));
    ...
    {
        return $this->services['hwi_oauth.user.provider.fosub_bridge'] = new \HWI\Bundle\OAuthBundle\Security\Core\User\FOSUBUserProvider($this->get('fos_user.user_manager'), array('github' => 'githubID', 'google' => 'githubID', 'facebook' => 'githubID'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.secure_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecureAreaService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/connect');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/hello/admin/');
        ...
        $n = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/home'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $n->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $o = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array('login_path' => 'fos_user_security_login', 'default_target_path' => '/home', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $o->setProviderKey('secure_area');

        $p = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array('login_path' => '/connect', 'default_target_path' => '/home', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $p->setProviderKey('secure_area');

        $q = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($b, $f, $g, $d, 'secure_area', $p, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('failure_path' => '/connect', 'login_path' => '/connect', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '/connect', 'use_forward' => false, 'require_previous_session' => true), $a, $c);
        $q->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.secure_area'));
        $q->setCheckPaths(array(0 => '/login/check-github', 1 => '/login/check-facebook', 2 => '/login/check-google'));

        return $this->services['security.firewall.map.context.secure_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username'), 1 => $m), 'secure_area', $a, $c), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $g, $d, 'secure_area', $o, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => 'fos_user_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => $q, 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5384f1cf9acd7', $a), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $d, 'secure_area', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($d, '/connect'), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('119ed70332fb8739bcd460e01b052a1a');
        $a->setPassword('fd286a54665a84519db2b6f37fa317f7');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\src\\Bdls\\ProjetBundle/Resources/views', 'BdlsProjet');
        $instance->addPath('C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\src\\Bdls\\UserBundle/Resources/views', 'user');
        $instance->addPath('C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\hwi\\oauth-bundle\\HWI\\Bundle\\OAuthBundle/Resources/views', 'HWIOAuth');
        $instance->addPath('C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/Resources/views');
        $instance->addPath('C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $a, 'secure_area', $this->get('security.encoder_factory'), true), 1 => new \HWI\Bundle\OAuthBundle\Security\Core\Authentication\Provider\OAuthProvider($this->get('hwi_oauth.user.provider.fosub_bridge'), $this->get('hwi_oauth.resource_ownermap.secure_area'), $a), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5384f1cf9acd7')), true);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml', 1 => 'C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml', 2 => 'C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev',
            'kernel.logs_dir' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/logs',
            'kernel.bundles' => array(
                ...
                'BdlsProjetBundle' => 'Bdls\\ProjetBundle\\BdlsProjetBundle',
                'userBundle' => 'Bdls\\userBundle\\userBundle',
            ...
            'user' => NULL,
            'password' => NULL,
            'facebook_client_id' => '359610224180052',
            'facebook_client_secret' => '56f4d32675c0fd39a2986e5a1ac514e9',
            'google_client_id' => '330767389348-acuj6f53cs45k4ge789jce27go8naoi9.apps.googleusercontent.com',
            'google_client_secret' => 'rIV9URsXROGewOrSbuynMYOS',
            ...
            'debug.container.dump' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
                1 => 'C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml',
                2 => 'C:\\wamp\\www\\Webdev_CIR3\\TP\\diapaClone\\diapazen\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => '119ed70332fb8739bcd460e01b052a1a',
            'swiftmailer.mailer.default.transport.smtp.password' => 'fd286a54665a84519db2b6f37fa317f7',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/../web',
            'assetic.write_to' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/Webdev_CIR3/TP/diapaClone/diapazen/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_user.model.user.class' => 'Bdls\\ProjetBundle\\Entity\\User',
