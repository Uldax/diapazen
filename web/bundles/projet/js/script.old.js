	...
	switch(input.className)
	{
		...
		case 'orange_button':			
			...
			switch(type){
				...
				//Type date
				case 'c2':
					choice.innerHTML =	'<label for="" class="lbl_choice text datepick" ></label>' 
								+' <input class="text_edit input_choice" id="" type="date" name="choices[] readonly="true"" /> '
							  +	'<a class="grey_button" title="Supprimer" type="button" onclick="manageChoices(this,\''+type+'\');">x</a>';
					break;
				case 'c3':
					choice.innerHTML =	'<label for="" class="lbl_choice text" ></label>' 
		...
		case 'grey_button':
			...
			// Suppression du champ de choixidentique pour chaque type d'input
